...
*/
		...
		this.drawText($gameVariables.value(4),0, 5);
		this.resetTextColor();
		this.drawText($gameVariables.value(5),160,5);
		this.changeTextColor(this.textColor(2));
		this.drawText($gameVariables.value(2),0, 45);
		this.resetTextColor();
		this.drawText($gameVariables.value(3),160,45);
	};
