...
Window_SavefileList.prototype.drawItem = function(index) {
    ...
    if (BBSWMaxItem >= 1) {
        this.contents.fillRect(rect.x + rect.width - 278, rect.y + 64, BBSWTF1, 26, this.textColor(BBSWOutFC));//タイトル背景
        this.contents.fillRect(rect.x + rect.width - 278, rect.y + 62, 276, 2, this.textColor(BBSWOutFC));//上の棒
/*        this.contents.fillRect(rect.x + rect.width - 278, rect.y + 90, 276, 2, this.textColor(BBSWOutFC));//下の棒 */
        this.contents.fillRect(rect.x + rect.width - 278 + 274, rect.y + 64, 2, 26, this.textColor(BBSWOutFC));//右の棒
    } if (BBSWMaxItem >= 2) {
        this.contents.fillRect(rect.x + rect.width - 278, rect.y + 32, BBSWTF2, 26, this.textColor(BBSWOutFC));
/*        this.contents.fillRect(rect.x + rect.width - 278, rect.y + 30, 276, 2, this.textColor(BBSWOutFC));*/
        this.contents.fillRect(rect.x + rect.width - 278, rect.y + 58, 276, 2, this.textColor(BBSWOutFC));
        this.contents.fillRect(rect.x + rect.width - 278 + 274, rect.y + 32, 2, 26, this.textColor(BBSWOutFC));
    } if (BBSWMaxItem >= 3) {
        this.contents.fillRect(rect.x + rect.width - 558, rect.y + 64, BBSWTF3, 26, this.textColor(BBSWOutFC));
        this.contents.fillRect(rect.x + rect.width - 558, rect.y + 62, 276, 2, this.textColor(BBSWOutFC));
/*        this.contents.fillRect(rect.x + rect.width - 558, rect.y + 90, 276, 2, this.textColor(BBSWOutFC));*/
        this.contents.fillRect(rect.x + rect.width - 558 + 274, rect.y + 64, 2, 26, this.textColor(BBSWOutFC));
    } if (BBSWMaxItem >= 4) {
        this.contents.fillRect(rect.x + rect.width - 558, rect.y + 32, BBSWTF4, 26, this.textColor(BBSWOutFC));
/*        this.contents.fillRect(rect.x + rect.width - 558, rect.y + 30, 276, 2, this.textColor(BBSWOutFC));*/
        this.contents.fillRect(rect.x + rect.width - 558, rect.y + 58, 276, 2, this.textColor(BBSWOutFC));
        this.contents.fillRect(rect.x + rect.width - 558 + 274, rect.y + 32, 2, 26, this.textColor(BBSWOutFC));
    }
...
//-----------------------------------------------------------------------------
//項目2 右上-------------------------------------------------------------------
        this.drawText(BBSWItem2T, rect.x + rect.width - 274, y2 - 30, BBSWTF2 - 10);
        if (BBSWItem2 == 1) {
            this.drawText(info.title, rect.x + rect.width - 274 + BBSWTF2, y2 - 30, 266 - BBSWTF2, 'right');//rect.x - 7, y2 - 34, rect.width
        } else if (BBSWItem2 == 2) {
            this.drawText(info.playtime, rect.x + rect.width - 274 + BBSWTF2, y2 - 30, 266 - BBSWTF2, 'right');
        } else if (BBSWItem2 == 3) {
            this.drawText(info.mapname, rect.x + rect.width - 274 + BBSWTF2, y2 - 30, 266 - BBSWTF2, 'right');
        } else if (BBSWItem2 == 4) {
            this.drawText(info.gold + TextManager.currencyUnit, rect.x + rect.width - 274 + BBSWTF2, y2 - 30, 266 - BBSWTF2, 'right');
        } else if (BBSWItem2 == 5) {
            this.drawText(info.savecount, rect.x + rect.width - 274 + BBSWTF2, y2 - 30, 266 - BBSWTF2, 'right');
        } else if (BBSWItem2 == 6) {
            this.drawText(info.value1 + BBSWV1u, rect.x + rect.width - 274 + BBSWTF2, y2 - 30, 266 - BBSWTF2, 'right');
        } else if (BBSWItem2 == 7) {
            this.drawText(info.value2 + BBSWV2u, rect.x + rect.width - 274 + BBSWTF2, y2 - 30, 266 - BBSWTF2, 'right');
        } else if (BBSWItem2 == 8) {
            this.drawText(info.value3 + BBSWV3u, rect.x + rect.width - 274 + BBSWTF2, y2 - 30, 266 - BBSWTF2, 'right');
        } else if (BBSWItem2 == 9) {
            this.drawText(info.value4 + BBSWV4u, rect.x + rect.width - 274 + BBSWTF2, y2 - 30, 266 - BBSWTF2, 'right');
        }
//-----------------------------------------------------------------------------
//項目3 左下-------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//項目4 左上-------------------------------------------------------------------
        this.drawText(BBSWItem4T, rect.x + rect.width - 554, y2 - 30, BBSWTF4 - 10);
        if (BBSWItem4 == 1) {
            this.drawText(info.title, rect.x + rect.width - 554 + BBSWTF4, y2 - 30, 266 - BBSWTF4, 'right');//rect.x - 287, y2 - 34, rect.width
        } else if (BBSWItem4 == 2) {
            this.drawText(info.playtime, rect.x + rect.width - 554 + BBSWTF4, y2 - 30, 266 - BBSWTF4, 'right');
        } else if (BBSWItem4 == 3) {
            this.drawText(info.mapname, rect.x + rect.width - 554 + BBSWTF4, y2 - 30, 266 - BBSWTF4, 'right');
        } else if (BBSWItem4 == 4) {
            this.drawText(info.gold + TextManager.currencyUnit, rect.x + rect.width - 554 + BBSWTF4, y2 - 30, 266 - BBSWTF4, 'right');
        } else if (BBSWItem4 == 5) {
            this.drawText(info.savecount, rect.x + rect.width - 554 + BBSWTF4, y2 - 30, 266 - BBSWTF4, 'right');
        } else if (BBSWItem4 == 6) {
            this.drawText(info.value1 + BBSWV1u, rect.x + rect.width - 554 + BBSWTF4, y2 - 30, 266 - BBSWTF4, 'right');
        } else if (BBSWItem4 == 7) {
            this.drawText(info.value2 + BBSWV2u, rect.x + rect.width - 554 + BBSWTF4, y2 - 30, 266 - BBSWTF4, 'right');
        } else if (BBSWItem4 == 8) {
            this.drawText(info.value3 + BBSWV3u, rect.x + rect.width - 554 + BBSWTF4, y2 - 30, 266 - BBSWTF4, 'right');
        } else if (BBSWItem4 == 9) {
            this.drawText(info.value4 + BBSWV4u, rect.x + rect.width - 554 + BBSWTF4, y2 - 30, 266 - BBSWTF4, 'right');
        }
//-----------------------------------------------------------------------------
//項目5 上部-------------------------------------------------------------------
