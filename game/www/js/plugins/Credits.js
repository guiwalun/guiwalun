...
var MENU_INSERT_INDEX = 3;

// Text for the Credits menu entry
var CREDITS_MENU_NAME = "Credits";
...
var GROUPS = {}
GROUPS["Localization"] = ["A-chan", "elfloren", "farcefield", "Kapurino Inc. Swaps4 Jake Caprino", "Kennoko", "MC", "Pekka “Vodoka” Luhtala", "Ray", "Shawn Gill"];
GROUPS["Quality Assurance"] = ["amaterasuthird", "AzureArtism", "Evade", "JackyHF", "Jeff Ireland", "MatiasDesu", "N-L", "razisgosu", "renellebum", "Yawning Soldier"];
//GROUPS["Editor"] = ["A-chan", "elfloren"];"Nicolina", "quo"
//GROUPS["Testers"] = ["Test Slave 1", "Test Slave 2", "Test Slave 3"];
//GROUPS["PlaceHolders"] = ["Test Slave 1", "Test Slave 2", "Test Slave 3"];
