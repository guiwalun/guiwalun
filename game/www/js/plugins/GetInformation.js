...
(function() {
    ...
    CommonPopupManager.showInfo = function(object, value, type, actor, c) {
        ...
        bitmap.fillRect(0, 0, infoWidth / 2, bitmap.height, 'rgba(0,0,0,0.8)');
        bitmap.gradientFillRect(infoWidth / 2, 0, infoWidth / 2, bitmap.height, 'rgba(0,0,0,0.8)', 'rgba(0,0,0,0)');
